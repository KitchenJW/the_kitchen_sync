const piclist =
['images/AMCI.jpg', 'images/Archibald Motley_Nightlife_1943.jpg',
'images/Archibald Motley_Saturday_Night_1935.jpg',
'images/camp.jpg', 'images/highlake.jpg',
'images/Killin.png', 'images/misticswamp.jpg', 'images/mount.jpg',
'images/soundgirl.jpg', 'images/swimmer.jpg', 'images/stuff.jpg',
'images/bike.jpg', 'images/city.jpg', 'images/ducklings.png',
'images/fence.jpg', 'images/grapes.jpg', 'images/labrador.jpg',
'images/minecraft.jpg', 'images/dragon.jpg', 'images/sbslogo.png',
'images/van.jpg']
...
let gameTime = null;
let stopClock = false;
let oMinutes = 5, oSeconds = 1;
let minutes = oMinutes, seconds = oSeconds;
...
const scaleFactor = Math.min(maxHeight / imgOriginalHeight, maxWidth /
imgOriginalWidth);
...
style="width:${pieceWidth * scaleFactor}; height:${pieceHeight *
scaleFactor};"
...
0, 0, pieceWidth * scaleFactor, pieceHeight * scaleFactor);
...
if (document.querySelector("#puzzle").innerHTML ==
`<img src="${img.src}">`) {
timeReset();
}
}, 1000);
...
`<h2 id="message">Nice Try Dude!</h2>
...
timeReset();
document.querySelector('#browse').innerHTML =
`<input type="file" id="musicLoader" onchange="loadAudio(event)" />`
}
function browseDefault() {
document.querySelector('#browse').innerHTML =
`<button id="pics" onclick="picChoice()">PICS</button>
...
hideToolbar();
// update picture:
document.querySelector('.modal-body').innerHTML = `<img src="${img.src}" />`;
}
function closeModal() {
// hide modal:
